...
const menuItems = [
  ...
  /* ── DESSERTS (15) ──────────────────────────────────────────── */
  { _id:"d1",  name:"Semiya Payasam",    category:"Desserts", price:180, veg:true,  vegan:false, dietary:false, description:"Traditional Kerala rice & coconut milk pudding with cardamom", image:semiyaPayasam },
  ...
  { _id:"d5",  name:"Rasmalai",          category:"Desserts", price:200, veg:true,  vegan:false, dietary:false, description:"Soft paneer discs soaked in chilled, saffron-infused sweetened milk", image:rasmalai },
  { _id:"d6",  name:"Paal Kozhukattai", category:"Desserts", price:160, veg:true,  vegan:false, dietary:false, description:"Rice flour dumplings simmered in sweetened coconut milk", image:paalKozhukattai },
  { _id:"d7",  name:"Adhirasam",         category:"Desserts", price:130, veg:true,  vegan:true,  dietary:false, description:"Traditional Tamil deep-fried rice & jaggery sweet", image:adhirasam },
  { _id:"d8",  name:"Sweet Pongal",      category:"Desserts", price:150, veg:true,  vegan:false, dietary:false, description:"Auspicious rice & lentil sweet with jaggery, ghee & cardamom", image:sweetPongal },
  { _id:"d9", name:"Badam Halwa",       category:"Desserts", price:220, veg:true,  vegan:false, dietary:false, description:"Rich almond halwa simmered in ghee, saffron & milk", image:bajjiHalwa },
  { _id:"d10", name:"Jangiri",           category:"Desserts", price:140, veg:true,  vegan:true,  dietary:false, description:"Crispy urad dal spirals soaked in light sugar syrup", image:jangiri },
  { _id:"d11", name:"Murukku",           category:"Desserts", price:100, veg:true,  vegan:true,  dietary:false, description:"Crunchy spiral rice-lentil snack — a South Indian festival staple", image:murukku },
  { _id:"d12", name:"Mysore Pak",        category:"Desserts", price:160, veg:true,  vegan:false, dietary:false, description:"Fudgy chickpea-flour sweet, loaded with ghee — a Mysore royal recipe", image:mysurePak },
  { _id:"d13", name:"Kheer",             category:"Desserts", price:170, veg:true,  vegan:false, dietary:false, description:"Slow-cooked rice pudding with full-cream milk, rose water & pistachios", image:kheer },
  { _id:"d14", name:"Kaju Katli",        category:"Desserts", price:180, veg:true,  vegan:false, dietary:false, description:"Diamond-shaped cashew fudge with silver leaf — a festive classic", image:kajuKatli },
