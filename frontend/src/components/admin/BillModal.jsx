    ...
    >
      <span
        className={`w-1.5 h-1.5 rounded-full ${
          paid ? "bg-emerald-400 animate-pulse" : "bg-orange-400"
        }`}
      />
      {status}
    </span>
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 90% 55% at 50% -5%, rgba(200,122,26,0.14) 0%, transparent 70%)",
              }}
            />
            ...
            <div
              ...
              style={{ borderBottom: "1px solid #2e1f08" }}
            >
              ...
              {/* Restaurant Name — class added for print fix */}
              <h1
              ...
              <p
                className="text-[10px] tracking-[0.22em] uppercase mb-3 font-semibold"
                style={{ color: "#b07830" }}
              >
                {RESTAURANT.tagline}
              </p>

              <p className="text-[11px] font-medium" style={{ color: "#9a6e3a" }}>
                {RESTAURANT.address}
              </p>
              ...
              <div className="flex items-center gap-3 mt-5">
                <div
                  ...
                  style={{ background: "linear-gradient(to right, transparent, #3e2a0e)" }}
                />
                ...
                <div
                  className="flex-1 h-px"
                  style={{ background: "linear-gradient(to left, transparent, #3e2a0e)" }}
                />
              </div>
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = "rgba(200,122,26,0.45)";
                  e.currentTarget.style.color = "#e8a83a";
                  e.currentTarget.style.background = "rgba(200,122,26,0.07)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = "#2a1a08";
                  e.currentTarget.style.color = "#7a5520";
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="flex items-start justify-between mb-5">
                    <div>
                      <p
                        className="text-[9px] uppercase tracking-[0.22em] mb-1 font-bold"
                        style={{ color: "#9a6e3a" }}
                      >
                        Bill #{orderId}
                      </p>
                      <p
                        ...
                        style={{ color: "#f0e6cc", fontFamily: "'Georgia', serif" }}
                      >
                        {bill.customer.name}
                      </p>
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      <span
                        ...
                        style={
                          bill.orderType === "walkin"
                            ? {
                                background: "rgba(200,122,26,0.14)",
                                color: "#d48a28",
                                border: "1px solid rgba(200,122,26,0.3)",
                              }
                            : {
                      ...
                      >
                        {bill.orderType === "walkin" ? "Dine-in" : "Delivery"}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mb-2">
                    <div
                      className="grid grid-cols-12 text-[10px] uppercase tracking-[0.18em] pb-2.5 font-bold"
                      style={{ color: "#9a6e3a" }}
                    >
                    ...
                    {bill.items.map((item, i) => (
                      <div
                        key={i}
                        className="grid grid-cols-12 py-2.5 border-t"
                        style={{ borderColor: "#261a08" }}
                      >
                        <span
                          className="col-span-6 text-[13px] font-semibold pr-2 leading-snug"
                          style={{ color: "#e8d8b0", fontFamily: "'Georgia', serif" }}
                        >
                          {item.name}
                        </span>
                        <span
                          className="col-span-2 text-[13px] text-center font-medium"
                          style={{ color: "#9a6e3a" }}
                        >
                          {item.quantity}
                        </span>
                        <span
                          className="col-span-2 text-[13px] text-right font-medium"
                          style={{ color: "#9a6e3a" }}
                        >
                          ₹{item.price}
                        </span>
                        <span
                          className="col-span-2 text-[13px] text-right font-bold"
                          style={{ color: "#d4a860" }}
                        >
                          ₹{item.subtotal}
                        </span>
                  ...
                  >
                    ...
                    {/* ── bill-total-amount class fixes invisible text on print ── */}
                    <span
                  ...
                  {/* Footer tagline */}
                  <p
                    className="text-center text-[10px] uppercase tracking-[0.25em] mb-5 font-semibold"
                    style={{ color: "#6b4e1a" }}
                  >
                    Heritage recipes · Finest spices · Timeless flavours
                  </p>

                  {/* Action Buttons — entire row hidden on print */}
                    ...
                    <div className="bill-no-print flex gap-3">
                      {!printed && (
                        <button
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.borderColor = "rgba(200,122,26,0.4)";
                            e.currentTarget.style.color = "#c87a1a";
                            e.currentTarget.style.background = "rgba(200,122,26,0.07)";
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.borderColor = "#3a2610";
                            e.currentTarget.style.color = "#9a6e3a";
                            e.currentTarget.style.background = "transparent";
                          }}
                        >
                          <svg viewBox="0 0 16 16" fill="none" className="w-3.5 h-3.5">
                            <path
                              d="M4 5V2h8v3M4 11H2V7h12v4h-2M4 9h8v5H4V9z"
                              stroke="currentColor"
                              strokeWidth="1.3"
                              strokeLinecap="round"
                      ...
                      {bill.paymentStatus !== "Paid" && (
                        <button
                          ...
                          disabled={paying}
                          className="flex-1 h-11 rounded-xl text-[11px] font-black uppercase tracking-wider flex items-center justify-center gap-2 transition-all duration-200 disabled:opacity-60"
                          style={{
                          ...
                          onMouseEnter={(e) => {
                            if (!paying)
                              e.currentTarget.style.background =
                                "linear-gradient(135deg, rgba(245,90,30,0.28), rgba(230,120,20,0.2))";
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.background =
                              "linear-gradient(135deg, rgba(245,90,30,0.18), rgba(230,120,20,0.12))";
                          }}
                        >
                          {paying ? (
                            <>
                ...
                <div className="flex flex-col items-center py-10 gap-3">
                  ...
                  <p className="text-sm font-medium" style={{ color: "#7a5520" }}>
                    Bill not found
                  </p>
                </div>
              )}
            ...
            {/* ── RECEIPT TEAR EDGE — screen only, hidden on print ── */}
