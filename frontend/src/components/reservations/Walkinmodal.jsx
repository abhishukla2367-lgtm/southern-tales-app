...
export default function WalkInModal({ open, onClose, onSave, occupiedTables = [] }) {
  ...
  const handleTableChange = (value) => {
    ...
    setTableWarning(value && occupiedTables.includes(value) ? "This table is occupied, please choose another." : "");
  };
